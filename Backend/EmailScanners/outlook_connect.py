...
LAMBDA_ENDPOINT = "https://gtqktd45m5rgjbpxsflqt2nj2y0ducar.lambda-url.ap-southeast-2.on.aws/"
#outlook scan
def run_outlook_scan(client_id, email, access_token, refresh_token):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"Failed to trigger scan. Status: {response.status_code}, Body: {response.text}")

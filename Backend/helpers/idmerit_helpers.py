...
import io
import uuid
from Database.db_utils import save_verification_request_to_db, fetch_clientid_from_requestid, delete_row_from_requestid
...
class IDMeritTokenManager:
    ...
    def get_valid_token(self) -> str:
        ...
        if self._access_token is None or current_time >= (self._token_expiry_timestamp - self._safety_buffer):
...
def send_idmerit_verification_message(client_id: str, phone_number: str, name: str, country: str, dob: str, redirectURL: str, callbackURL = "http://localhost") -> dict:
...
def upload_idmerit_user_image_s3(front_image: str, back_image: str, hashed_email: str, document_type: str) -> bool:
